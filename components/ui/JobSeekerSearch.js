...
export default function JobSeekerSearch({ placeholder, totalPages }) {
...
//   useEffect(() => {
//     handleSearch(); // Update URL when any filter changes
//   }, [page, search, workArrangement, contractType, minSalary, maxSalary]);

//   useEffect(() => {
//     setPage(1);
//     handleSearch();
//   }, [search, workArrangement, contractType, minSalary, maxSalary]);
