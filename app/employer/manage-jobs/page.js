        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {jobs.length ? (
            jobs.map((job) => (
              ...
              >
                ...
                <div className="mt-4 flex justify-between items-center">
                  ...
                  <Link href={`manage-jobs/applications/${job._id}`}>
                    {" "}
                    View Applications
                  </Link>
            ...
            <Link
              ...
              className="inline-flex items-center justify-center px-6 py-3 text-base font-medium text-white bg-blue-600 border border-transparent rounded-md shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
            >
              Create Job
            </Link>
          )}
